...
import StorePicker from './components/StorePicker.js' //path for our component
...
render(<StorePicker/>, document.querySelector('#main')); //component has to be self closing!
